...
func (r *CharacterRepository) Create(ctx context.Context, entrada CharacterCreateInput) (*CharacterSlot, error) {
	...
	documento := bson.M{
		...
		"pkkills":                 int32(0),
		"clanid":                  int32(0),
		"clan_crest_id":           int32(0),
		"clan_crest_large_id":     int32(0),
		"ally_id":                 int32(0),
		"ally_crest_id":           int32(0),
		"race":                    entrada.Race,
		"classid":                 entrada.ClassID,
		"base_class":              entrada.BaseClass,
		"deletetime":              int64(0),
		"title":                   entrada.Title,
		"name_color":              entrada.NameColor,
		"title_color":             entrada.TitleColor,
		"heading":                 int32(0),
		"rec_have":                int32(0),
		"rec_left":                int32(0),
		"clan_privileges":         int32(0),
		"online":                  int32(0),
		"onlinetime":              int32(0),
		"wantspeace":              int32(0),
		...
		"mount_type":              int32(0),
		"mount_npc_id":            int32(0),
		"operate_type":            int32(0),
		"team":                    int32(0),
		"abnormal_effect":         int32(0),
		"fishing":                 int32(0),
		"fishing_x":               int32(0),
		"fishing_y":               int32(0),
		"fishing_z":               int32(0),
	...
	return &CharacterSlot{
		...
		DeleteTime:           0,
		Title:                entrada.Title,
		NameColor:            entrada.NameColor,
		TitleColor:           entrada.TitleColor,
		Heading:              0,
		RecHave:              0,
		RecLeft:              0,
		ClanPrivileges:       0,
