...
func converterXmlClasseParaTemplate(classe xmlClasse) (templatePersonagemInicial, bool) {
	...
	template.pAtkSpd = 300
	if template.pAtk <= 3 {
		template.pAtkSpd = 333
	}
