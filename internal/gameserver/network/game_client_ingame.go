...
func (g *gameClient) processarRequestItemList(packet *requestItemListPacket) error {
	...
	return g.enviarPacket(montarItemListPacketComJanela(g.itensAtivos, g.augmentacoesAtivas, true))
}
...
func (g *gameClient) sincronizarPersonagemAtualComPlayerAtivo() {
	...
	g.personagemAtual.CurCp = g.playerAtivo.cpAtual
	g.personagemAtual.Running = g.playerAtivo.correndo
}
